...
function login() {
  ...
  if (user) {
  const role = user.role || "karyawan"; // default ke "karyawan" jika tidak ada role
  document.getElementById("gaji-info").style.display = "block";

  if (role === "admin") {
    document.getElementById("gaji-text").innerText = `👑 Selamat datang ADMIN ${user.nama.toUpperCase()}`;
    document.getElementById("update-form").style.display = "block";
    tampilkanSemuaReaksi(); // fungsi ini akan kita tambahkan di bawah
  } else {
